...
class RecentCollectionViewDataSource {
    ...
    func getData() {
        ...
        articles.value.insert(article1, at: 0)
        articles.value.insert(article2, at: 1)
        articles.value.insert(article0, at: 2)
    }
}
